...
public sealed class UnboundLauncherOptions
{
    ...
    /// </summary>
    public string ForwardAddr1 { get; set; } = "8.8.8.8";

    /// <summary>
    /// Secondary forward DNS for default zone (e.g. 8.8.4.4).
    /// </summary>
    public string ForwardAddr2 { get; set; } = "8.8.4.4";
    ...
    /// </summary>
    public string ChinaForwardAddr1 { get; set; } = "119.29.29.29";

    /// <summary>
    /// Secondary forward DNS for China zones (e.g. 119.28.28.28).
    /// </summary>
    public string ChinaForwardAddr2 { get; set; } = "119.28.28.28";
