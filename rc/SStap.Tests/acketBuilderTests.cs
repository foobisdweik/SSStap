...
public class PacketBuilderTests
{
    ...
    {
        var srcIp = IPAddress.Parse("\.8.8.8"\;
        var dstIp = IPAddress.Parse("\0.0.0.2"\;
        ushort srcPort = 443;
    ...
    {
        var srcIp = IPAddress.Parse("\.1.1.1"\;
        var dstIp = IPAddress.Parse("\0.0.0.3"\;
        ushort srcPort = 53;
    ...
    {
        var srcIp = IPAddress.Parse("\.9.9.9"\;
        var dstIp = IPAddress.Parse("\0.0.0.4"\;
    ...
    {
        var srcIp = IPAddress.Parse("\001:4860:4860::8888"\;
        var dstIp = IPAddress.Parse("\d00::1234"\;
        ushort srcPort = 53;
        ushort dstPort = 53000;
